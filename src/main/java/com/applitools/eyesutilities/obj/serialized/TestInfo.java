package com.applitools.eyesutilities.obj.serialized;

import com.applitools.eyesutilities.obj.*;
...
public class TestInfo {
    ...
    public void setStatus(com.applitools.eyesutilities.obj.Status status) {
        Status = status;
    }
